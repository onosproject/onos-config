...
test: deps lint vet license_check gofmt
	go test -short github.com/onosproject/onos-config/pkg/...
	go test -short github.com/onosproject/onos-config/cmd/...
	go test -short github.com/onosproject/onos-config/modelplugin/...
