...
test: build deps linters license_check
	...
	-CGO_ENABLED=1 go test github.com/onosproject/onos-config/pkg/...
	-CGO_ENABLED=1 go test github.com/onosproject/onos-config/cmd/...
	-CGO_ENABLED=1 go test github.com/onosproject/onos-config/modelplugin/...
...
k3d: images
	...
	k3d import-images onosproject/onos-config:${ONOS_CONFIG_DEBUG_VERSION}
