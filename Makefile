...
MODELPLUGINS = build/_output/testdevice.so.1.0.0 build/_output/testdevice.so.2.0.0 build/_output/devicesim.so.1.0.0 build/_output/stratum.so.1.0.0 build/_output/junos.so.19.3R1
MODELPLUGINSDEBUG = build/_output/testdevice-debug.so.1.0.0 build/_output/testdevice-debug.so.2.0.0 build/_output/devicesim-debug.so.1.0.0 build/_output/stratum-debug.so.1.0.0 build/_output/junos-debug.so.19.3R1
...
build/_output/junos.so.19.3R1: modelplugin/Junos-19.3R1/modelmain.go modelplugin/Junos-19.3R1/junos_19_3R1/generated.go
	CGO_ENABLED=1 go build -o build/_output/junos.so.19.3R1 -buildmode=plugin -tags=modelplugin ./modelplugin/Junos-19.3R1

build/_output/junos-debug.so.19.3R1: modelplugin/junos-19.3R1/modelmain.go modelplugin/junos-19.3R1/junos_19_3R1/generated.go
	CGO_ENABLED=1 go build -o build/_output/debug/junos-debug.so.19.3R1 -gcflags "all=-N -l" -buildmode=plugin -tags=modelplugin ./modelplugin/junos-19.3R1
