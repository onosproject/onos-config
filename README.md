# onos-config
[![Build Status](https://travis-ci.com/onosproject/onos-config.svg?branch=master)](https://travis-ci.com/onosproject/onos-config)
[![Integration Test Status](https://img.shields.io/travis/onosproject/onos-config?label=Integration%20Tests&logo=Integration)](https://travis-ci.com/onosproject/onos-test)
