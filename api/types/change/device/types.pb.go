...
import (
	...
	github_com_onosproject_onos_config_pkg_types "github.com/onosproject/onos-config/api/types"
...
type NetworkChangeRef struct {
	...
	ID github_com_onosproject_onos_config_pkg_types.ID `protobuf:"bytes,1,opt,name=id,proto3,casttype=github.com/onosproject/onos-config/api/types.ID" json:"id,omitempty"`
	// 'index' is the index of the network change from which this change was created
	Index github_com_onosproject_onos_config_pkg_types.Index `protobuf:"varint,2,opt,name=index,proto3,casttype=github.com/onosproject/onos-config/api/types.Index" json:"index,omitempty"`
}
...
type Change struct {
	...
	DeviceType github_com_onosproject_onos_config_pkg_types_device.Type `protobuf:"bytes,3,opt,name=device_type,json=deviceType,proto3,casttype=github.com/onosproject/onos-config/api/types/device.Type" json:"device_type,omitempty"`
...
var fileDescriptor_4abdafea6ed8dfb1 = []byte{
	...
	,
}
