...
import (
	"flag"
	"fmt"
	"github.com/opennetworkinglab/onos-config/cmd/onos-config-manager/shell"
	"github.com/opennetworkinglab/onos-config/pkg/events"
	"github.com/opennetworkinglab/onos-config/pkg/listener"
	"github.com/opennetworkinglab/onos-config/pkg/northbound/restconf"
	"github.com/opennetworkinglab/onos-config/pkg/southbound/synchronizer"
