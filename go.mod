...
require (
	...
	github.com/onosproject/onos-api/go v0.8.29
...
replace github.com/onosproject/onos-api/go => github.com/teone/onos-api/go v0.8.25-0.20220124185457-96c4beb083d6
