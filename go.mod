...
require (
	...
	github.com/onosproject/config-models/modelplugin/devicesim-1.0.0 v0.6.31
	github.com/onosproject/config-models/modelplugin/testdevice-1.0.0 v0.6.31
	github.com/onosproject/config-models/modelplugin/testdevice-2.0.0 v0.6.31
