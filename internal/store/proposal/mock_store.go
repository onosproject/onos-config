...
// Source: github.com/onosproject/onos-config/pkg/store/proposal (interfaces: Store)
...
import (
	...
	proposal "github.com/onosproject/onos-config/pkg/store/proposal"
)
...
func (m *MockStore) Create(arg0 context.Context, arg1 *v2.Proposal) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Get(arg0 context.Context, arg1 v2.ProposalID) (*v2.Proposal, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1)
	ret0, _ := ret[0].(*v2.Proposal)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetKey(arg0 context.Context, arg1 v2.Target, arg2 string) (*v2.Proposal, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) List(arg0 context.Context) ([]*v2.Proposal, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Update(arg0 context.Context, arg1 *v2.Proposal) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateStatus(arg0 context.Context, arg1 *v2.Proposal) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Watch(arg0 context.Context, arg1 chan<- v2.ProposalEvent, arg2 ...proposal.WatchOption) error {
	m.ctrl.T.Helper()
