...
// Package utils implements various gNMI value manipulation facilities.
package utils
...
func NewSetRequest(values []configapi.PathValue, target configapi.TargetID) (*gnmi.SetRequest, error) {
...
// NewTypedValue converts gnmi type based values in to native byte array changes
func NewTypedValue(gnmiTv *gnmi.TypedValue, modelPath *adminapi.ReadWritePath) (*configapi.TypedValue, error) {
