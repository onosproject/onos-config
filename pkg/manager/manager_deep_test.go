...
func Test_SetNetworkConfig_ConfigOnly_Deep(t *testing.T) {
	...
	err := mgrTest.SetNetworkConfig(updatesForConfigOnlyDevice, deletesForConfigOnlyDevice, deviceInfo, string(testNetworkChange), false)
...
func Test_SetNetworkConfig_Disconnected_Device(t *testing.T) {
	...
	err := mgrTest.SetNetworkConfig(updatesForDisconnectedDevice, deletesForDisconnectedDevice, deviceInfo, string(testNetworkChange), false)
