...
// deprecated: only needed for old legacy style stores
...
func Test_SetNetworkConfig(t *testing.T) {
	...
	// Verify the change
	validationError := mgrTest.ValidateNewNetworkConfig(device1, deviceVersion1, deviceTypeTd, updates, deletes)
