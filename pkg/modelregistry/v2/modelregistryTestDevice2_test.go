...
func Test_SchemaTestDevice2(t *testing.T) {
	...
	assert.Equal(t, list2aRxp.ValueType, configapi.ValueType_UINT, "expected /cont1a/list2a[name=*]/rx-power to be UINT")
	...
	assert.Equal(t, leaf2d3c.ValueType, configapi.ValueType_STRING, "expected /cont1a/cont2d/leaf2d3c to be STRING")

	beer, beerOk := readWritePathsTestDevice2["/cont1a/cont2d/beer"]
	assert.Assert(t, beerOk, "expected to get /cont1a/cont2d/beer")
	assert.Equal(t, beer.ValueType, configapi.ValueType_EMPTY, "expected /cont1a/cont2d/beer to be EMPTY")
	...
	assert.Equal(t, pretzel.ValueType, configapi.ValueType_EMPTY, "expected /cont1a/cont2d/pretzel to be EMPTY")
	...
	assert.Equal(t, chocolate.ValueType, configapi.ValueType_STRING, "expected /cont1a/cont2d/chocolate to be STRING")
}
