...
func Test_TypeForPath(t *testing.T) {
	...
	assert.Equal(t, modelType1, configapi.ValueType_STRING)
	...
	assert.Equal(t, modelType2, configapi.ValueType_STRING)
	...
	assert.Equal(t, modelType3, configapi.ValueType_EMPTY)
}
