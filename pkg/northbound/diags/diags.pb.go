...
type ListDeviceChangeRequest struct {
	...
	// after all devices have been streamed to the client
	Subscribe bool `protobuf:"varint,1,opt,name=subscribe,proto3" json:"subscribe,omitempty"`
	// device_id is the device for which to list changes
	...
	// device_version is an optional device version for which to list changes
...
func (m *ListDeviceChangeRequest) GetDeviceID() github_com_onosproject_onos_topo_pkg_northbound_device.ID {
	if m != nil {
		return m.DeviceID
	}
	return ""
...
func (m *ListDeviceChangeRequest) GetDeviceVersion() string {
	if m != nil {
...
var fileDescriptor_624d839d9ad9df06 = []byte{
	...
	,
}
