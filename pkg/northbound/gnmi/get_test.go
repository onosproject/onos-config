...
func Test_getAllDevices(t *testing.T) {
	...
	assert.Equal(t, deviceListStr,
		"[Device1 (1.0.0), Device2 (1.0.0), Device2 (2.0.0), device-1-device-simulator (1.0.0), device-2-device-simulator (1.0.0), device-3-device-simulator (1.0.0), localhost:10161 (1.0.0), localhost:10162 (1.0.0), localhost:10163 (1.0.0)]")
}
