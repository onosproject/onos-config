...
type AdminServiceClient interface {
	...
	ListRegisteredModels(ctx context.Context, in *ListModelsRequest, opts ...grpc.CallOption) (AdminService_ListRegisteredModelsClient, error)
...
func (c *adminServiceClient) ListRegisteredModels(ctx context.Context, in *ListModelsRequest, opts ...grpc.CallOption) (AdminService_ListRegisteredModelsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AdminService_serviceDesc.Streams[0], "/proto.AdminService/ListRegisteredModels", opts...)
	if err != nil {
		return nil, err
	}
	x := &adminServiceListRegisteredModelsClient{stream}
...
type AdminService_ListRegisteredModelsClient interface {
	Recv() (*ModelInfo, error)
	grpc.ClientStream
}

type adminServiceListRegisteredModelsClient struct {
	grpc.ClientStream
}

func (x *adminServiceListRegisteredModelsClient) Recv() (*ModelInfo, error) {
	m := new(ModelInfo)
...
func (c *adminServiceClient) GetNetworkChanges(ctx context.Context, in *NetworkChangesRequest, opts ...grpc.CallOption) (AdminService_GetNetworkChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AdminService_serviceDesc.Streams[1], "/proto.AdminService/GetNetworkChanges", opts...)
	if err != nil {
		return nil, err
	}
...
type AdminServiceServer interface {
	...
	// ListRegisteredModels returns a stream of registered models.
	ListRegisteredModels(*ListModelsRequest, AdminService_ListRegisteredModelsServer) error
	// GetNetworkChanges returns a stream of network changes submitted via gNMI.
...
func (*UnimplementedAdminServiceServer) ListRegisteredModels(req *ListModelsRequest, srv AdminService_ListRegisteredModelsServer) error {
...
func _AdminService_ListRegisteredModels_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListModelsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AdminServiceServer).ListRegisteredModels(m, &adminServiceListRegisteredModelsServer{stream})
}

type AdminService_ListRegisteredModelsServer interface {
	Send(*ModelInfo) error
	grpc.ServerStream
}

type adminServiceListRegisteredModelsServer struct {
	grpc.ServerStream
}

func (x *adminServiceListRegisteredModelsServer) Send(m *ModelInfo) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _AdminService_ListRegisteredModels_Handler,
			ServerStreams: true,
		},
		{
