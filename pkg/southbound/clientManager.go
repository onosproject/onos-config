...
func createDestination(device devicetype.Device) (*client.Destination, DeviceID) {
...
func (target *Target) ConnectTarget(ctx context.Context, device devicetype.Device) (DeviceID, error) {
