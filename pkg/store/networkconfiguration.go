...
// CreateNetworkConfiguration creates a NetworkConfiguration object
// If name is left blank then a name will be generated by a hash algorithm
func CreateNetworkConfiguration(name string, user string, changes map[ConfigName]change.ID) (*NetworkConfiguration, error) {
