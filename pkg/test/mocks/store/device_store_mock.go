...
func (m *MockDeviceStore) Get(arg0 topo.ID) (*topo.Object, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceStore) List(arg0 chan<- *topo.Object) error {
	m.ctrl.T.Helper()
...
func (m *MockDeviceStore) Update(arg0 *topo.Object) (*topo.Object, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceStore) Watch(arg0 chan<- *topo.SubscribeResponse) error {
	m.ctrl.T.Helper()
