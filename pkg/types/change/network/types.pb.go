...
type NetworkChange struct {
	...
	Status change.Status `protobuf:"varint,4,opt,name=status,proto3,enum=onos.config.change.Status" json:"status,omitempty"`
	// 'reason' indicates the reason the change failed if in the FAILED state
	Reason change.FailureReason `protobuf:"varint,5,opt,name=reason,proto3,enum=onos.config.change.FailureReason" json:"reason,omitempty"`
	...
	Changes []*device.Change `protobuf:"bytes,9,rep,name=changes,proto3" json:"changes,omitempty"`
}
...
func (m *NetworkChange) GetReason() change.FailureReason {
	if m != nil {
		return m.Reason
	}
...
var fileDescriptor_6ff4173a93edd736 = []byte{
	...
	,
}
