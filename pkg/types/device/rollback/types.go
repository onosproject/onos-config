...
// ID is a rollback identifier type
type ID types.ID

// NewID returns a new device rollback ID from the given network rollback ID, device ID, and device version
...
// GetDeviceID returns the device ID from the rollback ID
...
// GetDeviceVersion returns the device version from the rollback ID
