...
// GetDeviceRollbackID returns the device rollback ID for the given device/version
func (s *NetworkRollback) GetDeviceRollbackID(deviceID device.ID, version string) rollback.ID {
	return rollback.NewID(types.ID(s.ID), deviceID, version)
}
