...
func Test_DecomposeTree(t *testing.T) {
	...
	for _, pathValue := range pathValues {
		...
		case
			...
			assert.Equal(t, configapi.ValueType_STRING, pathValue.Value.GetType(), pathValue.Path)
		case
			...
			assert.Equal(t, configapi.ValueType_UINT, pathValue.Value.GetType(), pathValue.Path)
		default:
...
func Test_DecomposeTreeConfigOnly(t *testing.T) {
	...
	for _, v := range pathValues {
		...
		case
			...
			assert.Equal(t, configapi.ValueType_STRING, v.Value.GetType(), v.Path)
		default:
...
func Test_findModelRwPathNoIndices(t *testing.T) {
	...
	assert.Equal(t, configapi.ValueType_STRING, rwElem.ValueType)
}
...
func Test_findModelRoPathNoIndices(t *testing.T) {
	...
	assert.Equal(t, configapi.ValueType_STRING, roAttr.ValueType)
}
...
func Test_replaceIndices(t *testing.T) {
	...
	indices = append(indices, indexValue{"a", configapi.NewTypedValueString("12"), 0})
	indices = append(indices, indexValue{"b", configapi.NewTypedValueUint(34, 8), 1})
	indices = append(indices, indexValue{"c", configapi.NewTypedValueInt(56, 8), 2})
	indices = append(indices, indexValue{"d", configapi.NewTypedValueString("78"), 3})
	indices = append(indices, indexValue{"e", configapi.NewTypedValueString("9"), 4})
	indices = append(indices, indexValue{"f", configapi.NewTypedValueString("10"), 5})
...
func Test_replaceIndices2(t *testing.T) {
	...
	indices := make([]indexValue, 0)
	indices = append(indices, indexValue{"d", configapi.NewTypedValueString("78"), 4})
	indices = append(indices, indexValue{"e", configapi.NewTypedValueString("9"), 5})
	indices = append(indices, indexValue{"f", configapi.NewTypedValueString("10"), 6})
